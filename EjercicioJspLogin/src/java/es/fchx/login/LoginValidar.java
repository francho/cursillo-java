...
public class LoginValidar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Cogemos los parametros que nos pasan y nos interesan (de moemento no valida la contraseña)
            ...
            if (login != null && !login.equals("")) {
                ...
                sc.setAttribute("titulo", "Error de identificación");

                rd.include(request, response);

                out.println("<p>El login o la clave que has introducido no son correctos, por favor <a href=\"javascript:history.back()\">prueba otra vez</a>");
