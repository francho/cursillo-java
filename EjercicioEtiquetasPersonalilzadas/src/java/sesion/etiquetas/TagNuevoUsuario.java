...
public class TagNuevoUsuario extends BodyTagSupport {
    private Usuario nuevoUsuario;
    
    /** 
     * Creates new instance of tag handler 
     */
    public TagNuevoUsuario() {
        super();
    }
    ...
    public int doEndTag() throws JspException {
        ...
        GestorUsuarios gestor = (GestorUsuarios) pageContext.getSession().getAttribute("gestor");
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in TagNuevoUsuario tag", ex);
    }
